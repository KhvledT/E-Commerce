      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <Button
            ...
            className="bg-white/80 border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
          >
        ...
        {error && (
          <div className="mb-8 p-6 rounded-xl shadow-lg border-l-4 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 border-gray-700">
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-full flex items-center justify-center mr-4 bg-gray-200">
                ...
                <CardContent className="p-8">
                  <div className="flex justify-between items-start mb-6">
                      ...
                      <div className="flex items-center mb-3">
                        ...
                        <div>
                          <h3 className="font-bold text-2xl text-gray-900">
                            ...
                            {index === 0 && (
                              <span className="ml-3 px-3 py-1 bg-black text-white text-xs font-semibold rounded-full">
                                Latest
                              </span>
                            )}
                          </h3>
                    ...
                    <div className="text-right">
                      <p className="font-bold text-3xl text-gray-900 mb-3">
                    ...
                    {order.cartItems.length === 0 ? (
                      ...
                      <div className="space-y-4">
                        {order.cartItems.map((item) => (
                          <div key={item._id} className="flex items-center gap-6 p-6 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-all duration-300">
                            ...
                            <div className="flex-1">
                              <h5 className="font-semibold text-lg text-gray-900 mb-2">{item.product.title}</h5>
        ...
        <div className="mt-12 flex justify-center">
          <Button
            ...
            disabled={loading}
            className="bg-white/80 border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold px-8 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
          >
            {loading ? (
              <div className="flex items-center">
